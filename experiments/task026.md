...
| --- | --- | --- | --- | --- | --- |
| passes_local | 19.09463815194543 | 330 | 37 | 2026-06-15T00:28:46+09:00 | exp003 |
...
| exp003 | impl_opt | threshold01-color-grid-equal | passes_local | 19.09463815194543 | 330 | 37 | 0.25795295598 | promoted | Auto promoted after canonical re-score. |
...
- `threshold01-color-grid-equal` (`0.1-1.0`): replace the `false7`/`false9` channel filler initializers with a compact `UINT8` 0/8 color grid plus `Equal(colors10, color5x3)`. This should keep similar intermediate memory while dropping about 100 params; failure would show the direct one-hot filler path is still cheaper after Equal materialization.
