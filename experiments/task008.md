...
- Revisited after task010/task002 `ReduceSum` height/count wins: task008 needs exact first/last bbox coordinates for red and blue to compute movement and dynamic pads. Counts alone cannot replace those `ArgMax` coordinates without losing position information.
