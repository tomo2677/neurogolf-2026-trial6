...
def build_model() -> onnx.ModelProto:
    ...
    nodes: list[onnx.NodeProto] = [
        ...
        helper.make_node("Where", ["has_col", "input_color_t", "input_color_u8"], ["canon_input_color"]),
        helper.make_node("And", ["has_col", "valid_area_t"], ["valid_area_t_selected"]),
        helper.make_node("And", ["not_has_col", "valid_area"], ["valid_area_orig_selected"]),
        helper.make_node("Or", ["valid_area_t_selected", "valid_area_orig_selected"], ["canon_valid_area"]),
        helper.make_node("Where", ["has_col", "col_line_color_t", "row_line_color"], ["canon_line_color"]),
        ...
        helper.make_node("Where", ["has_col", "color_grid_t", "canon_color_grid"], ["color_grid_final"]),
