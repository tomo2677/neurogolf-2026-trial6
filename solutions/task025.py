...
def build_model() -> onnx.ModelProto:
    ...
    nodes: list[onnx.NodeProto] = [
        ...
        helper.make_node("Greater", ["row_max_color", "zero_u8"], ["row_nonzero"]),
        helper.make_node("Greater", ["col_max_color", "zero_u8"], ["col_nonzero"]),
        helper.make_node("And", ["row_uniform", "row_nonzero"], ["row_line_any"]),
        helper.make_node("And", ["col_uniform", "col_nonzero"], ["col_line_any"]),
        helper.make_node("Where", ["row_line_any", "row_max_color", "zero_u8"], ["row_line_color"]),
        helper.make_node("Where", ["col_line_any", "col_max_color", "zero_u8"], ["col_line_color"]),
