...
def build_model() -> onnx.ModelProto:
    ...
    initializers = [
        ...
        _int32_tensor("input_col_grid_i32", list(range(INPUT_SIZE)), [1, 1, 1, INPUT_SIZE]),
    ...
    nodes = [
        ...
        helper.make_node("Cast", ["safe_spatial"], ["safe_spatial_idx"], to=onnx.TensorProto.INT64),
        ...
        helper.make_node("Reshape", ["nonzero_u8", "shape_flat144"], ["nonzero_flat_u8"]),
        helper.make_node("Gather", ["nonzero_flat_u8", "safe_spatial_idx"], ["gathered_nonzero_u8"], axis=0),
