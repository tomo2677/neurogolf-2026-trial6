...
def build_model() -> onnx.ModelProto:
    ...
    initializers = [
        ...
        _int64_tensor("row_ch1_starts", [1, 0, 0], [3]),
        _int64_tensor("row_ch1_ends", [2, SIZE, 1], [3]),
        _int64_tensor("row_ch3_starts", [3, 0, 0], [3]),
        _int64_tensor("row_ch3_ends", [4, SIZE, 1], [3]),
        _int64_tensor("col_ch2_starts", [2, 0, 0], [3]),
        _int64_tensor("col_ch2_area_ends", [3, SIZE, SIZE], [3]),
    ...
    nodes = [
        ...
        helper.make_node("Slice", ["row_by_color", "row_ch1_starts", "row_ch1_ends", "axes_chw"], ["row_has_1_f32"]),
        helper.make_node("Slice", ["row_by_color", "row_ch3_starts", "row_ch3_ends", "axes_chw"], ["row_has_3_f32"]),
        helper.make_node("Slice", ["input", "col_ch2_starts", "col_ch2_area_ends", "axes_chw"], ["col2_area"]),
