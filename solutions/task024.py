...
def build_model() -> onnx.ModelProto:
    ...
    initializers = [
        ...
        _int64_tensor("col_ch2_ends", [1, 3, 1, SIZE], [4]),
    ...
    nodes = [
        ...
        helper.make_node("Greater", ["row_present15", "zero_f32"], ["row_valid"]),
        helper.make_node("Greater", ["col_present15", "zero_f32"], ["col_valid"]),
        helper.make_node("And", ["row_valid", "col_valid"], ["valid_area"]),
        helper.make_node("ReduceMax", ["input"], ["row_by_color"], axes=[3], keepdims=1),
        helper.make_node("ReduceMax", ["input"], ["col_by_color"], axes=[2], keepdims=1),
        ...
        helper.make_node("Slice", ["col_by_color", "col_ch2_starts", "col_ch2_ends"], ["col_has_2_f32"]),
    ...
    graph = helper.make_graph(nodes, "task024_public15_rowcol_presence_graph", [x], [y], initializers)
