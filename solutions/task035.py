...
def build_model() -> onnx.ModelProto:
    ...
    nodes.extend(
        [
            ...
            helper.make_node("Slice", ["color", "col0_starts", "row3_i64", "axis_row"], ["color_rows0_2"]),
            helper.make_node("Slice", ["color", "row3_i64", "row4_i64", "axis_row"], ["color_row3"]),
