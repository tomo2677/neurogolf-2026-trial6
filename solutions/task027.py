...
def build_model() -> onnx.ModelProto:
    ...
    initializers = [
        ...
        _int64_tensor("col7_tail_starts", [5, 7], [2]),
        _int64_tensor("col7_tail_ends", [7, 8], [2]),
    ...
    nodes = [
        ...
        helper.make_node("Slice", ["blue_u8", "rev10_starts", "rot10_ends", "rev_axes", "rev_steps"], ["rot10_inner"]),
        helper.make_node("Pad", ["rot10_inner", "pads_rot10_hw", "", "rev_axes"], ["rot10"], mode="constant"),
        helper.make_node("ReduceMax", ["blue_u8", "three_i64"], ["row_present"], keepdims=1),
        helper.make_node("Slice", ["blue_u8", "col7_tail_starts", "col7_tail_ends", "rev_axes"], ["col7_tail"]),
