...
def build_model() -> onnx.ModelProto:
    ...
    initializers = [
        ...
        _int64_tensor("rev10_start", [9], [1]),
        _int64_tensor("rev10_end", [-11], [1]),
        _int64_tensor("rev9_start", [8], [1]),
        _int64_tensor("rev9_end", [-10], [1]),
        _int64_tensor("rev_step", [-1], [1]),
    ...
    nodes = [
        ...
        helper.make_node("Slice", ["blue_bool", "rev10_start", "rev10_end", "axis_h", "rev_step"], ["rot9_v"]),
        helper.make_node("Slice", ["rot9_v", "rev10_start", "rev10_end", "axis_w", "rev_step"], ["rot9"]),
        helper.make_node("Slice", ["blue_bool", "inner_starts", "inner_ends"], ["inner9"]),
        helper.make_node("Slice", ["inner9", "rev9_start", "rev9_end", "axis_h", "rev_step"], ["rot10_inner_v"]),
        helper.make_node("Slice", ["rot10_inner_v", "rev9_start", "rev9_end", "axis_w", "rev_step"], ["rot10_inner"]),
