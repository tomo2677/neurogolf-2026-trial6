...
def build_model() -> onnx.ModelProto:
    ...
    nodes: list[onnx.NodeProto] = [
        ...
        helper.make_node("Div", ["selected_index", "three_i64"], ["row_block"]),
        helper.make_node("Mod", ["selected_index", "three_i64"], ["col_block"]),
        helper.make_node("Mul", ["row_block", "four_i64"], ["row_start"]),
        helper.make_node("Mul", ["col_block", "four_i64"], ["col_start"]),
        helper.make_node("Add", ["row_start", "three_i64"], ["row_end"]),
        helper.make_node("Add", ["col_start", "three_i64"], ["col_end"]),
    ...
    graph = helper.make_graph(nodes, "task011_arithmetic_block_bounds_graph", [x], [y], initializers, value_info=value_infos)
