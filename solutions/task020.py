...
def build_model() -> onnx.ModelProto:
    ...
    initializers = [
        ...
        _int64_tensor("c1_ends", [1, 2, 10, 10], [4]),
        _int64_tensor("c2_starts", [0, 2, 0, 0], [4]),
        _int64_tensor("c2_ends", [1, 3, 10, 10], [4]),
        _int64_tensor("c3_starts", [0, 3, 0, 0], [4]),
        _int64_tensor("c3_ends", [1, 4, 10, 10], [4]),
        _int64_tensor("c4_starts", [0, 4, 0, 0], [4]),
        _int64_tensor("c4_ends", [1, 5, 10, 10], [4]),
    ...
    nodes: list[onnx.NodeProto] = [
        ...
        helper.make_node("Slice", ["input", "c3_starts", "c3_ends"], ["c3_f32"]),
