...
def build_model() -> onnx.ModelProto:
    ...
    nodes = [
        ...
        helper.make_node("Reshape", ["target_mask_bool", "shape_flat900"], ["target_mask_flat_bool"]),
        helper.make_node("Gather", ["target_mask_flat_bool", "safe_spatial"], ["crop_target_bool"], axis=0),
